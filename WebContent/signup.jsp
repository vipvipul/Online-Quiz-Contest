        ...
        <div class="col-md-6">
          <form action="Register" method="post">
            <div class="form-group">
              ...
              <dl class="dl-horizontal">
                <dt><label for="studentIDReg" class="control-label">Student ID</dt>
                  <dd><input type="text" class="form-control" placeholder="eg. 1610902094" id='studentIDReg' name="studentID" required/></dd>
              </dl>
               <dl class="dl-horizontal">
              ...
              <dl class="dl-horizontal">
                <dt><label for="yearReg" class="control-label">Year</dt>
                  <dd>
                    <div class="row">
                      <div class="col-md-3">
                        <input type="radio" id='yearReg' name='year' value='1st' required/> 1st
                      </div>
                      <div class="col-md-3">
                        <input type="radio" id='yearReg' name='year' value='2nd' required/> 2nd
                      </div>
                    </div>
                  </dd>
              </dl>
              <dl class="dl-horizontal">
                <dt><label for="streamReg" class="control-label">Stream</dt>
                  <dd>
                    <select class="form-control" id="streamReg" name="stream" required >
                      <option>CSE</option>
                      <option>CIVIL</option>
                      <option>ECE</option>
                      <option>EE</option>
...
if("error1".equals(msg)){%>
	<div class="container animated fadeInLeft" align="center" style="color:#00008B;font-size:18px"><%="Student ID already registered!!"%></div>
	<%session.invalidate();
