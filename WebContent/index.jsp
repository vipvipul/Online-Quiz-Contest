      ...
      <div class="navbar navbar-default">
        <div class="container">
          <div class="navbar-header">
            ...
            <I><b class="navbar-brand animated fadeInUp">AAHVAHAN - Dare 2 Code</b></I>
          </div>
          ...
          <form action="LoginValidate" method="get">
            <div class="form-group">
              <dl class="dl-horizontal">
                <dt><label for='emailLogin' class="col-sm-2 col-md-2 control-label">Student ID</lable></dt>
                <dd><input type='text' class='form-control' id='emailLogin' placeholder="Enter your student ID" name="studentID" required/></dd>
              </dl>
              <dl class="dl-horizontal">
